...
```text
/OpenDragy/runs/{runId}/{runId}.json       # metrics + embedded raw block
/OpenDragy/runs/{runId}/{runId}_gps.csv    # raw GPS (id in name for multi-run compare)
/OpenDragy/runs/{runId}/{runId}_imu.csv    # raw IMU (g)
```
